...
class I_II_III_IV_State extends State<I_II_III_IV> {
  ...
  void initState() {
    ...
    if(Provider.of<Adulto>(context, listen: false).fecha_ultima_visitatemp == "")Provider.of<Adulto>(context, listen: false).fecha_ultima_visitatemp = DateFormat("y-M-d").format(DateTime.now());
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: <Widget>[motivoHistoria(), historiaMedica(), revision_organos_y_sistemas(), generalI()],
        ),
      ),
    );
  }
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ListTile(
            leading: Icon(Icons.calendar_today),
            title: Text(
              Provider.of<Adulto>(context).fecha_ultima_visitatemp,
              style: TextStyle(
            ...
            onTap: () {
              Util()
                  .selectDate(context, DateFormat("y-M-d").parse(Provider.of<Adulto>(context).fecha_ultima_visitatemp), DateTime.now())
                  .then((fecha) {
                setState(() {
