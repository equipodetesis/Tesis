      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              if (Provider.of<Adulto>(context).motivo == "" ) {
                  Provider.of<Adulto>(context).setError(false);
              } else {
                showDialog(
                    context: context,
              ...
              if(Provider.of<Cirugia>(context).padecimiento_actual == ""){
                Provider.of<Cirugia>(context).setError(false);
              } else {
                showDialog(
                    context: context,
                    barrierDismissible: false,
