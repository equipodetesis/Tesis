...
class Adulto{
  ...
  radioterapia="", vacunas_recibidas="",clienteid;
  bool cambiado;
...
void clear(){
  ...
  otros_enfermedades_padecidas=""; operaciones=""; trans_sanguine_somet="";
  radioterapia=""; vacunas_recibidas="";clienteid="";cambiado=false;
}
  void fromjson(Map<String, dynamic> data) {
    ...
    radioterapia=data["radioterapia"]; vacunas_recibidas=data["vacunas_recibidas"];clienteid=data["ClienteID"];
  }
