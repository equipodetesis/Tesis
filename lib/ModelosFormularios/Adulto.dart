...
class Adulto{
 ...
 Adulto();
  ...
  void fromjson(Map<String, dynamic> data) {
    motivo = data["motivo_consulta"];historia=data["historia_enfermedad_actual"];fecha_ultima_visita=data["fecha_ultima_visita"];
    tratamiento_recibido=data["tratamiento"] ; dientes_perdidos=data["dientes_perdidos"];
    causa_dientesperdidos=data["causa_dientes_perdidos"] ; experiencias_exodoncias=data["exper_exodocias"] ;
    ...
    cuidadoMedico=data["cuidado_medico"];hospital=data["hospital"];expediente=data["expediente_medico"];
    fecha_ultimo_examen_medico=data["ult_exam_medico"];
  ...
  Map<String,dynamic> toMap()=>{
    ...
    "nombre_medico":nombredelmedico,"enfermedades":enfermedades,"UserID":Userid,"ClienteID":clienteid
  };
  void clear(){
    motivo = "";historia="";fecha_ultima_visita="";
    tratamiento_recibido="" ; dientes_perdidos="";
    causa_dientesperdidos="" ; experiencias_exodoncias="" ;
    higiene_oral="" ; tipo_cepillo ="";tecnica_cepillado="" ;
    frecuencia_cepillado="" ; ayudas_higiene_extras="" ;
    cuidadoMedico="";hospital="";expediente="";
    fecha_ultimo_examen_medico="";
    nombredelmedico="";enfermedades=List<String>();
  }
