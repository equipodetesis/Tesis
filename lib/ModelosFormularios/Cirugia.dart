...
class Cirugia{
  ...
  tratamiento_inmunologico, tratamiento_tegumentario, tratamiento_temporomandibular, otra_digestivo, otra_respiratorio, otra_cardiovascular, otra_genitourinario, otra_endocrino, otra_hematologico, otra_neurologico, otra_musculo_esqueleto,
      otra_inmunologico, otra_tegumentario, otra_radiografia, Userid, clienteid ;
  ...
  inmunologico = List(), tegumentario = List(), temporomandibular = List(), radiografia = List(), analisis_laboratorio = List(), padecimiento_actual = List(), fecha_cirugia = List();
  ...
  void clear(){
    ...
    inmunologico = List(); tegumentario = List(); temporomandibular = List(); radiografia = List(); analisis_laboratorio = List(); padecimiento_actual = List(); fecha_cirugia = List(); cambiado = false ; exostosis = false; endostosis = false; asimetrias_transversales = false; asimetrias_longitudinales = false; enoftalmo = false;
  ...
  void fromjson(Map<String, dynamic> data) {
    ...
    otra_radiografia = data["otra_radiografia"]; clienteid = data["ClienteID"]; Userid = data["UserID"]; fecha_cirugia = List.from(data["fecha_cirugia"]);
  }
