...
class Adulto{
  String motivo , historia, tratamiento , dientes_perdidos , causa_dientesperdidos , experiencias_exodoncias , higiene_oral , tipo_cepillo , tecnica_cepillado ,
      frecuencia_cepillado , ayudas_higiene_extras ,cuidadoMedico,hospital,expediente,ultimoexamenmedico,nombredelmedico;
 ...
 Adulto();
  ...
  Adulto.fromjson(Map<String, dynamic> data):
        motivo=data["motivo_consulta"] , historia=data["historia_enfermedad_actual"], tratamiento=data["tratamiento"] , dientes_perdidos=data["dientes_perdidos"] ,
